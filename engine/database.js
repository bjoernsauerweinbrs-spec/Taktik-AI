window.ToniDatabase = {
    players: JSON.parse(localStorage.getItem('toni_players')) || [
        { id: 1, name: "PROFI", pos: "ST", rating: 94, pace: 99, sho: 92, pas: 88, dri: 91, def: 45, phy: 84, photo: 'https://via.placeholder.com/200x300/111/39FF14?text=ZIEHEN' }
    ],
    ...
    biometrics: JSON.parse(localStorage.getItem('toni_bio')) || {
        weight: { val: 78.5, max: 100, unit: 'kg' },
        kfa: { val: 11.2, max: 25, unit: '%' }
    },
    save() {
