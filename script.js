/* ==========================================================================
   TONI 2.0 | NEURAL ELITE ENGINE CORE (V14.1 - STABLE RESTORE)
   ========================================================================== */
...
function systemBootSequence() {
    ...
    // Sicherung: Falls kein Passwortfeld da ist, trotzdem starten
    ...
    if (pass === "1234") { 
        ...
        alert("ACCESS DENIED: Passwort ist 1234");
    }
}

// Komfort-Funktion: Enter-Taste im Passwortfeld drückt den Button
...
async function initEliteCore() {
    console.log("TONI 2.0 V14.1: System Integrity Check... OK");
    updateClock(); 
...
function updateKPIs() {
    ...
    if(el) el.innerText = eliteStore.mgmt.liquidAssets.toLocaleString() + " €";
